...
namespace CRM.Pages
{
    public class fattorahsucessModel : PageModel
    {
        ...
        public fattorahsucessModel(IRazorPartialToStringRenderer renderer, PerfumeContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration, IEmailSender emailSender, Microsoft.AspNetCore.Hosting.IHostingEnvironment env)
        {
            _renderer = renderer;
            _context = context;
        ...
        static string liveURL = "https://api-sa.myfatoorah.com/v2/GetPaymentStatus";
                    ...
                    try
                    {
                        if (fattorahPaymentResult.UserDefinedField != null)
                        {
                            ...
                            if (checkRes)
                            {
                                ...
                                order = await _context.Order.Include(e => e.OrderItem).Where(e => e.OrderId == orderId).FirstOrDefaultAsync();
