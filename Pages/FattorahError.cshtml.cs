...
namespace CRM.Pages
{
    public class FattorahErrorModel : PageModel
    {
        ...
        string res { set; get; }
        public FattorahErrorModel(IRazorPartialToStringRenderer renderer, PerfumeContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration, IEmailSender emailSender, Microsoft.AspNetCore.Hosting.IHostingEnvironment env)
        {
            _renderer = renderer;
            _context = context;
