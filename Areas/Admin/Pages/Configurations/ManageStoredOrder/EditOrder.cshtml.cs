    ...
    public class EditOrderModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost(int Id)
        {
            ...
            catch
            {
                ...
                return Redirect("/Admin/Configurations/ManageStoredOrder/EditOrder?Id=" + Id);
        ...
        public async Task<IActionResult> OnPostEditpaymentmethod(int OrderId)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                return Redirect("/Admin/Configurations/ManageStoredOrder/EditOrder?Id=" + OrderId);
        ...
        public async Task<IActionResult> OnPostDeleteOrderItem(int OrderId)
        {
            try
            {
                ...
                if (orderItemsList.Count == 0)
                {
                    ...
                    return Redirect("/Admin/Configurations/ManageStoredOrder/Orders");
