...
namespace CRM.Pages
{
    public class InvoiceModel : PageModel
    {
        ...
        public IActionResult OnGet(string serialNo)
        {
            try
            {
                Order = _context.Order.Include(a => a.CustomerAddress).Include(a => a.CustomerN).Include(e => e.OrderStatus).Include(e => e.Country).Where(e=>e.OrderSerial==serialNo).Select(i => new InvoiceVm
                {
                    OrderId=i.OrderId,
